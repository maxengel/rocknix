...
make_target() {
  ...
  # Select dosbox target/dynarec by architecture (was hardcoded arm64, which
  # compiles ARM assembly and breaks on x86_64).
  case ${TARGET_ARCH} in
    x86_64)  DOSBOX_TARGET="x86_64"; DOSBOX_DYNAREC="x86_64" ;;
    aarch64) DOSBOX_TARGET="arm64";  DOSBOX_DYNAREC="arm64" ;;
    arm)     DOSBOX_TARGET="arm";    DOSBOX_DYNAREC="arm" ;;
    *)       DOSBOX_TARGET="unix";   DOSBOX_DYNAREC="oldcore" ;;
  esac
