...
| `203-question-over-sync-640x480-5b795f2e49.png` | #203 | Build 4: A on START NEW GAME while BACK UP SAVES TO THE CLOUD (the card, a player-started sync) runs at 247 KB OF 461 KB: `YOUR SAVES ARE SYNCING WITH THE CLOUD. / IF YOU STOP IT, THE NEXT SYNC FINISHES WHAT THIS ONE DID NOT.`, STOP IT AND PLAY / KEEP WAITING |
| `203-question-over-sync-640x480-8b533d76ec.png` | #203 | The same question on build 5 |
| `203-sync-row-after-stop-640x480-8b533d76ec.png` | #203 | After STOP IT AND PLAY, the game and a quit: BACK UP SAVES TO THE CLOUD reads `LAST 09/15/2026 18:54 - SKIPPED, A GAME WAS STARTED` (build 4 read COULDN'T FINISH here: the script's stamp had no token; build 5 stamps it) |
| `203-question-over-transfer-640x480-8b533d76ec.png` | #203 | A on START NEW GAME while a BACK UP TO THE CLOUD from the transfer page runs in the background: `YOUR BACKUP TO THE CLOUD IS STILL RUNNING. / IF YOU STOP IT, WHAT IT HAS NOT MOVED YET WAITS FOR THE NEXT RUN.`, STOP IT AND PLAY / KEEP WAITING |
| `203-game-after-stop-640x480-8b533d76ec.png` | #203 | Twelve seconds after STOP IT AND PLAY over the transfer: Böbl running (the transfer's group SIGTERM'd, gone within a second; the game up before the second check at 2 s) |
| `203-transfer-row-after-stop-640x480-8b533d76ec.png` | #203 | The CLOUD hub afterwards: BACK UP TO THE CLOUD reads `LAST 09/15/2026 19:11 - SKIPPED - YOU STARTED A GAME` while the run is current |
