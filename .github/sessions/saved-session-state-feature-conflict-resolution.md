...
- **H700 RC build running** since 05:07:51 UTC from `/workspace/repos/rocknix.worktrees/devices` at `c5c50a2d5f` (`build-dev.sh H700`; log `/workspace/tmp/rocknix-session/build-h700-c5c50a2d5f.log`; a persistent Monitor watches for `H700 BUILD OK|FAILED`). On OK: copy `target/ROCKNIX-H700.aarch64-<date>*` to `/workspace/artifacts/rocknix-images/h700-all-<date>-c5c50a2d5f/`, write `SHA256SUMS.tar`, verify the tar's ES binary carries `The network is up, so trying again in`.
